...
/*未加密，用来测试加密策略未NONE情况*/
insert into sys_user values ('6', 'admin', 'admin', 'admin@foxmail.com', '郑州东区', 24, 0, 0, 0);


-- 明文MD5数据
/*admin*/
insert into sys_user values ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@foxmail.com', '广州天河', 24, 0, 0, 0);
/*12345678*/
